<div id="nav">
    <div class="navBox">
        <ul>
            ...
            <li>
                <a href="/category/6">家居建材</a></li>
            <li>
                <a href="/category/5">服装鞋帽</a></li>
            <li>
                <a href="/category/138">集成墙</a></li>
            <li>
                <a href="/category/35">生活服务</a></li>
            <li>
                <a href="/category/8">母婴教育</a></li>
            <li><a href="/category/95">休闲食品</a></li>
            <li><a href="/category/70">农村致富</a></li>
            <li class="last"></li>
