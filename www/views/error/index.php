...
<head>
    ...
    <link href="<?=GlobalUrlService::buildStaticUrl("/bootstrap/v3/css/bootstrap.min.css");?>" rel="stylesheet">
    <script src="<?=GlobalUrlService::buildStaticUrl("/plugins/jquery/jquery-3.2.1.min.js");?>"></script
</head>
