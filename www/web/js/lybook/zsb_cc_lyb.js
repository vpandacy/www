...
document.writeln("#lyb { width: 100%; }");
document.writeln("#lyb .lybmain {}");
document.writeln("#lyb h3 {width: 100%; height: 72px; line-height: 72px; text-align: center; text-indent: -9999px; font-size: 12px; background:#fff url(/Public/zsbcc06/images/bg/lybHtop.png) no-repeat center; }");
...
document.writeln("#lyb .lybLeft .leftMain h4 { width: 100%; height: 52px; background: #ffc200 url(/Public/zsbcc06/images/bg/dianhua.png) no-repeat center; margin: 0 auto; line-height: 52px; text-indent: -9999px; }");
...
document.writeln("#lyb .lybLeft .leftMain .leftBtn { width: 88%; height: 91px; border: 2px solid #00b6f3; margin: 0 auto; border-radius: 5px; background: url(/Public/zsbcc06/images/bg/dianhuabtn.png) repeat-x bottom;  }");
...
document.writeln("#lyb .lybLeft .leftMain .leftBtn .sub { width: 100%; height: 47px; border: none; line-height: 47px; text-align: center; cursor: pointer; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px; background: url(/Public/zsbcc06/images/bg/dianhuabtn1.png) no-repeat center; text-indent: -9999px; }");
...
document.writeln("#lyb .lybRight .rightMain h4 { width: 100%; height: 30px; line-height: 30px; letter-spacing:1px; margin-bottom: 8px; font-size: 20px; color: #fff; text-indent: 34px; background: url(/Public/zsbcc06/images/bg/rightH.png) no-repeat left center; }");
document.writeln("#lyb .lybRight .rightMain label { width: 100%; display: block; margin-bottom: 12px; color: #fff; padding: 0 5px; font-weight: bold; font-size: 13px; }");
document.writeln("#lyb .lybRight .rightMain label .rightTxt { width: 50%; height: 37px; line-height: 37px; background: #fff; border: 1px solid #bfecfb; margin-left: 5px; text-indent: 12px; }");
document.writeln("#lyb .lybRight .rightMain label span { float: left; overflow: hidden; }");
document.writeln("#lyb .lybRight .rightMain label .textarea { width: calc(50% - 20px); height: 107px; border: 1px solid #bfecfb; border-right: none; margin-left: 5px; vertical-align: top; padding: 10px; resize: none; float: left; background: #fff url(/Public/zsbcc06/images/bg/txtBox.png) no-repeat center right; overflow-y: hidden }");
...
document.writeln("#lyb .lybRight .rightMain label .sub {width: 50%; height: 43px; border: none; margin:0px auto;display:block; cursor: pointer; background: url(/Public/zsbcc06/images/bg/btn.png) repeat-x; font-size: 16px; line-height: 43px; text-align: center; color: #fff; font-weight: bold;}");
document.writeln("</style>");

document.writeln("<div id=\"lyb\">");
document.writeln("	<div class=\"lybmain\" style=\"width:"+widthSize+";margin:0 auto;\">");
...
document.writeln('		<input name="lybid" type="hidden" value="4">');
...
document.writeln("					<label><input type=\"submit\" class=\"sub\" value=\"提交留言\" id=\"sub\" /></label>");
document.writeln("				</div>");
document.writeln("			</div>");
...
//	var aInput = oLeftBtn.getElementsByTagName('input');
...
function callmenow(){
	...
	var arrUrl = [ '/Public/zsbcc06/images/bg/dianhuabtn1.png', '/Public/zsbcc06/images/bg/dianhuabtn2.png' ];
...
//	document.getElementById('callme').style.background  = 'url('+ arrUrl[1] +') no-repeat center';
	...
	$.ajax({
		type: 'POST',
		timeout : 180000,
		url: 'http://tp.hao987.cn/Api/zsbcallme',
		data: {
			'phone' : idv.value,
			'khid' : khid,
			'url' : url2
